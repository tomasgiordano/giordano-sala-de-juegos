...
export class ZFigura extends Monocluster{
  ...
  public constructor(x : number,y : number,width : number,height : number){
    ...
    this.mono[0] = new MonoSprite(x,y,width,height,"red");
    this.mono[1] = new MonoSprite(x,y+30,width,height,"red");
    this.mono[2] = new MonoSprite(x-30,y,width,height,"red");
    this.mono[3] = new MonoSprite(x+30,y+30,width,height,"red");
  }
